 ...
 * gameoptions.inc.php
 *
 * Vughex game options description
 *
 ...
 *        with the same ID (see "initGameStateLabels" in vughex.game.php)
 *
...
$game_options = [
  ...
  100 => [
    ...
    "values" => [
      ...
      2 => ["name" => totranslate("2 scores (default)")],
      3 => ["name" => totranslate("3 scores")],
    ],
    "default" => 2,
  ],
];
