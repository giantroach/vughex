...
$gameinfos = [
  ...
  "presentation" => [
    ...
    //    ...
    totranslate(
      "VUGHEX is a 2 players competitive card game. Players make use of 14 kind of the unit cards and its ability to take a control of 3 lanes."
    ),
    totranslate(
      "The game is structed by a minimal 18 cards. However, there is a deep depth that makes you think carefully and strategy that experiences and skills are required than luck."
    ),
  ],
